...
test('the application returns a successful response in the home page', function () {
    ...
    $this->assertStringContainsString('<h1>Home Page</h1>', $response->content());
    $this->assertStringContainsString('<title>Watchly - Home</title>', $response->content());
    $this->assertStringContainsString('<a href="/">Home</a>', $response->content());
    $this->assertStringContainsString('<a href="/movies">Movies</a>', $response->content());
});
...
test('the application returns a successful response in the movies page', function () {
    ...
    $response->assertStatus(200);
    $this->assertStringContainsString('<h1>Movies Page</h1>', $response->content());
    $this->assertStringContainsString('<title>Watchly - Movies</title>', $response->content());
    $this->assertStringContainsString('<a href="/">Home</a>', $response->content());
    $this->assertStringContainsString('<a href="/movies">Movies</a>', $response->content());
});
